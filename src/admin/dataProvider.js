...
export default (apiUrl, httpClient = fetchUtils.fetchJson, countHeader = 'Content-Range') => ({
        ...
        return httpClient(url, options).then(({ headers, json }) => {
            ...
            return {
                ...
                total: countHeader === 'Content-Range' ?
                    parseInt(headers.get('content-range').split('/').pop(), 10) : parseInt(headers.get(countHeader.toLowerCase())),
            };
        });
    },
    ...
    getManyReference: (resource, params) => {
        ...
        const query = {
            ...
            filter: JSON.stringify(Object.assign(Object.assign({}, params.filter), {
